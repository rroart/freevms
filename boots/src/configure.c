...
void someone_wrote(void)
{
    ...
    sts = sys$qiow(0, cf_mbxchan, /*IO$M_NOW|*/IO$_READVBLK, &iosb, 0, 0,
    ...
    sts = sys$qiow(0, cf_mbxchan, IO$_SETMODE | IO$M_WRTATTN, &iosb, 0, 0,
                   someone_wrote, 0, 0, 0, 0, 0);
}
...
#endif
    int sts = sys$qiow(0, cf_mbxchan, IO$_SETMODE | IO$M_WRTATTN, &iosb, 0, 0,
                       someone_wrote, 0, 0, 0, 0, 0);
