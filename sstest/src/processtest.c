...
int call_sys$getjpiw1(unsigned short int code, void *value,
...
int call_sys$getjpiw2(unsigned short int code1, void *value1,
...
int call_sys$setprn(char *process_name)
{
    ...
    {
        (unsigned short) strlen(process_name), DSC$K_DTYPE_T, DSC$K_CLASS_S,
        process_name
    };
