...
int exe_std$abortio(struct _irp *irp, struct _pcb *pcb, struct _ucb *ucb,
                    int qio_sts);
int exe_std$alloc_bufio_32(struct _irp *irp, struct _pcb *pcb, void *uva32,
                           int pktdatsiz);
int exe_std$alloc_bufio_64(struct _irp *irp, struct _pcb *pcb, VOID_PQ uva64,
                           int pktdatsiz);
...
int exe_std$alophycntg_color_s2(int npages, int rad, int byte_align,
                                VOID_PPQ sva_p);
void exe_std$altquepkt(struct _irp *irp, struct _ucb *ucb);
int exe$bugchk_cancel_remove_va(VOID_PQ start_va,
...
int exe$cbb_allocate(CBB_PPQ cbb, int unitsize, int bits, int ipl,
                     unsigned long long flags, int timeout_value);
int exe$cbb_clear_bit(int flags, int bitpos, CBB_PQ src, CBB_PQ dst,
                      INT_PQ ccode);
int exe$cbb_empty(CBB_PQ cbb, int flags, INT_PQ state);
int exe$cbb_find_first_clear(CBB_PQ cbb, int start, int flags, INT_PQ bitpos,
                             INT_PQ ccode);
int exe$cbb_find_first_set(CBB_PQ cbb, int start, int flags, INT_PQ bitpos,
                           INT_PQ ccode);
int exe$cbb_get_size(int unitsize, int bits, INT_PQ resultsize);
int exe$cbb_initialize(CBB_PQ cbb, int blksiz, int unitsize, int bits, int ipl,
                       unsigned long long flags, int timeout_value);
...
int exe$cbb_extract_bitmask(CBB_PQ src, int start, int length, int flags,
                            VOID_PQ bitmask_addr);
int exe$cbb_insert_bitmask(int start, int length, int flags,
                           VOID_PQ bitmask_addr, CBB_PQ cbb);
int exe$cbb_validate(CBB_PQ cbb, int unitsize, int bits, int ipl,
                     unsigned long long flags, int timeout_value, UINT64_PQ ret_flags);
int exe$cbb_zero(CBB_PQ cbb, int flags);
int exe$cbb_boolean_oper(int flags, int function, CBB_PQ cbb1, CBB_PQ cbb2,
                         CBB_PQ dst, INT_PQ ccode);
int exe_std$check_device_access(int, int, struct _pcb *pcb, struct _ucb *ucb);
int exe_std$chkflupages(void);
int exe_std$chkpro_int(struct _arb *arb, struct _orb *orb,
                       struct _chpctl *chpctl, struct _chpret *chpret);
int exe_std$chkcreacces(struct _arb *arb, struct _orb *orb, struct _pcb *pcb,
                        struct _ucb *ucb);
int exe_std$chkdelacces(struct _arb *arb, struct _orb *orb, struct _pcb *pcb,
                        struct _ucb *ucb);
int exe_std$chkexeacces(struct _arb *arb, struct _orb *orb, struct _pcb *pcb,
                        struct _ucb *ucb);
int exe_std$chklogacces(struct _arb *arb, struct _orb *orb, struct _pcb *pcb,
                        struct _ucb *ucb);
int exe_std$chkphyacces(struct _arb *arb, struct _orb *orb, struct _pcb *pcb,
                        struct _ucb *ucb);
int exe_std$chkrdacces(struct _arb *arb, struct _orb *orb, struct _pcb *pcb,
                       struct _ucb *ucb);
int exe_std$chkwrtacces(struct _arb *arb, struct _orb *orb, struct _pcb *pcb,
                        struct _ucb *ucb);
...
int exe_std$debit_bytcnt_alo(int debit, struct _pcb *pcb, int32 *alosize_p,
                             void **pool_p);
int exe_std$debit_bytcnt_bytlm_alo(int debit, struct _pcb *pcb,
                                   int32 *alosize_p, void **pool_p);
int exe_std$debit_bytcnt_bytlm_nw(int debit, struct _pcb *pcb);
int exe_std$finishio(struct _irp *irp, struct _ucb *ucb);
int exe$illiofunc(struct _irp *irp, struct _pcb *pcb, struct _ucb *ucb,
                  struct _ccb *ccb);
...
int exe_std$iorsnwait(struct _irp *irp, struct _pcb *pcb, struct _ucb *ucb,
                      struct _ccb *ccb, int qio_sts, int rsn);
int exe$kp_allocate_kpb(struct _kpb **kpb_p, int stksiz, int flags,
                        int paramsiz);
...
int exe$kp_start(struct _kpb *kpb, void (*rout)(struct _kpb *kpb),
                 long long regmask);
void exe_std$kp_startio(struct _irp *irp, struct _ucb *ucb);
int exe$kp_tqe_wait(struct _kpb *kpb, long long *ticks, int spnlidx);
int exe_std$lcldskvalid(struct _irp *irp, struct _pcb *pcb, struct _ucb *ucb,
                        struct _ccb *ccb);
...
int exe_std$modify(struct _irp *irp, struct _pcb *pcb, struct _ucb *ucb,
                   struct _ccb *ccb);
...
#else
int exe_std$modifylock(struct _irp *irp, struct _pcb *pcb, struct _ucb *ucb,
                       struct _ccb *ccb, void *buf, int bufsiz,
                       void (*err_rout)(struct _irp *irp, struct _pcb *pcb, struct _ucb *ucb,
                                        struct _ccb *ccb, int errsts));
#endif
...
int exe_std$oneparm(struct _irp *irp, struct _pcb *pcb, struct _ucb *ucb,
                    struct _ccb *ccb);
...
#endif
void exe_std$primitive_fork_wait(long long fr3, long long fr4,
                                 struct _fkb *fkb);
...
int exe_std$read(struct _irp *irp, struct _pcb *pcb, struct _ucb *ucb,
                 struct _ccb *ccb);

#ifdef  __INITIAL_POINTER_SIZE
int exe_std$readchk (struct _irp *irp, struct _pcb *pcb, struct _ucb *ucb, VOID_PQ buf, int bufsiz);
#else
int exe_std$readchk(struct _irp *irp, struct _pcb *pcb, struct _ucb *ucb,
                    void *buf, int bufsiz);
#endif
...
int exe_std$readlock (struct _irp *irp, struct _pcb *pcb, struct _ucb *ucb, struct _ccb *ccb,
                      ...
                      void (*err_rout)(struct _irp *irp, struct _pcb *pcb, struct _ucb *ucb,
                                       struct _ccb *ccb, int errsts));
#else
int exe_std$readlock(struct _irp *irp, struct _pcb *pcb, struct _ucb *ucb,
                     struct _ccb *ccb, void *buf, int bufsiz,
                     void (*err_rout)(struct _irp *irp, struct _pcb *pcb, struct _ucb *ucb,
                                      struct _ccb *ccb, int errsts));
#endif
...
int exe_std$sensemode(struct _irp *irp, struct _pcb *pcb, struct _ucb *ucb,
                      struct _ccb *ccb);
int exe_std$setchar(struct _irp *irp, struct _pcb *pcb, struct _ucb *ucb,
                    struct _ccb *ccb);
int exe_std$setmode(struct _irp *irp, struct _pcb *pcb, struct _ucb *ucb,
                    struct _ccb *ccb);
...
int exe_std$write(struct _irp *irp, struct _pcb *pcb, struct _ucb *ucb,
                  struct _ccb *ccb);

#ifdef  __INITIAL_POINTER_SIZE
int exe_std$writechk (struct _irp *irp, struct _pcb *pcb, struct _ucb *ucb, VOID_PQ buf, int bufsiz);
#else
int exe_std$writechk(struct _irp *irp, struct _pcb *pcb, struct _ucb *ucb,
                     void *buf, int bufsiz);
#endif
...
int exe_std$writelock (struct _irp *irp, struct _pcb *pcb, struct _ucb *ucb, struct _ccb *ccb,
                       ...
                       void (*err_rout)(struct _irp *irp, struct _pcb *pcb, struct _ucb *ucb,
                                        struct _ccb *ccb, int errsts));
#else
int exe_std$writelock(struct _irp *irp, struct _pcb *pcb, struct _ucb *ucb,
                      struct _ccb *ccb, void *buf, int bufsiz,
                      void (*err_rout)(struct _irp *irp, struct _pcb *pcb, struct _ucb *ucb,
                                       struct _ccb *ccb, int errsts));
#endif
...
int exe_std$zeroparm(struct _irp *irp, struct _pcb *pcb, struct _ucb *ucb,
                     struct _ccb *ccb);
void ini$brk(void);
...
int exe$nampid(struct _pcb *p, unsigned long *pidadr, void *prcnam,
               struct _pcb ** retpcb, unsigned long * retipid, unsigned long *retepid);
...
int exe$finishio(long status1, long status2, struct _irp * i, struct _pcb * p,
                 struct _ucb * u);
int exe$finishioc(long status, struct _irp * i, struct _pcb * p,
                  struct _ucb * u);
...
int exe$allocate(int requestsize, void ** poolhead, int alignment,
                 unsigned int * allocatedsize, void ** returnblock);
...
int exe$allocate_pool(int requestsize, int pooltype, int alignment,
                      unsigned int * allocatedsize, void ** returnblock);
...
asmlinkage int exe$assign(void *devnam, unsigned short int *chan,
                          unsigned int acmode, void *mbxnam, int flags);
...
asmlinkage int exe$setimr(unsigned int efn, signed long long *daytim,
                          void (*astadr)(long), unsigned long reqidt, unsigned int flags);
...
asmlinkage int exe$deltva(struct _va_range *inadr, struct _va_range *retadr,
                          unsigned int acmode);
asmlinkage int exe$imgsta(void * transfer, void * parseinfo, void * header,
                          void * file, unsigned long linkstatus, unsigned long clistatus);
asmlinkage int exe$imgact(void * name, void * dflnam, void * hdrbuf,
                          unsigned long imgctl, unsigned long long * inadr,
                          unsigned long long * retadr, unsigned long long * ident,
                          unsigned long acmode);
asmlinkage int exe$crmpsc(struct _va_range *inadr, struct _va_range *retadr,
                          unsigned int acmode, unsigned int flags, void *gsdnam,
                          unsigned long long * ident, unsigned int relpag,
                          unsigned /*short*/long chan, unsigned int pagcnt, unsigned int vbn,
                          unsigned int prot, unsigned int pfc);
asmlinkage int exe$schdwk(unsigned int *pidadr, void *prcnam,
                          signed long long * daytim, signed long long * reptim);
asmlinkage int exe$cretva(struct _va_range *inadr, struct _va_range *retadr,
                          unsigned int acmode);
...
asmlinkage int exe$forcex(unsigned int *pidadr, void *prcnam,
                          unsigned int code);
asmlinkage int exe$mount(void *itmlst);
asmlinkage int exe$creprc(unsigned int *pidadr, void *image, void *input,
                          void *output, void *error, struct _generic_64 *prvadr,
                          unsigned int *quota, void*prcnam, unsigned int baspri, unsigned int uic,
                          unsigned short int mbxunt, unsigned int stsflg, ...);
asmlinkage int exe$crembx(char prmflg, unsigned short int *chan,
                          unsigned int maxmsg, unsigned int bufquo, unsigned int promsk,
