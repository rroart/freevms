...
struct _pdt
{
    ...
    int (*pdtvec$l_allocdg)(void);
    int (*pdtvec$l_allocmsg)(void);
    int (*pdtvec$l_deallocdg)(void);
    int (*pdtvec$l_deallomsg)(void);
    int (*pdtvec$l_ins_pes_mfreeq)(void);
    int (*pdtvec$l_ins_opt_mfreeq)(void);
    int (*pdtvec$l_rem_opt_mfreeq)(void);
    int (*pdtvec$l_rem_pes_mfreeq)(void);
    int (*pdtvec$l_add_free_dg)(void);
    int (*pdtvec$l_rem_free_dg)(void);
    int (*pdtvec$l_queue_dg)(void);
    int (*pdtvec$l_reqdata)(void);
    int (*pdtvec$l_senddata)(void);
    int (*pdtvec$l_senddatawmsg)(void);
    int (*pdtvec$l_senddg)(int disposition_flag, int dg_msg_length, struct _cdrp *cdrp);
    int (*pdtvec$l_sendmsg)(void);
    int (*pdtvec$l_sendmsgl)(void);
    int (*pdtvec$l_trnmsgh)(void);
    int (*pdtvec$l_trnmsgl)(void);
    int (*pdtvec$l_readcount)(void);
    int (*pdtvec$l_rlscount)(void);
    int (*pdtvec$l_mreset)(void);
    int (*pdtvec$l_mstart)(void);
    int (*pdtvec$l_stop_vcs)(void);
    int (*pdtvec$l_shut_all_vc)(void);
    int (*pdtvec$l_crash_vc)(void);
    int (*pdtvec$l_crash_port)(void);
    int (*pdtvec$l_reinit_port)(void);
    int (*pdtvec$l_flush_vc)(void);
    int (*pdtvec$l_log_error_scs)(void);
    int (*pdtvec$l_cleanup_pkt)(void);
    int (*pdtvec$l_pb_from_msg)(void);
    int (*pdtvec$l_chk_lost_ack)(void);
    int (*pdtvec$l_remove_pb)(void);
    int (*pdt$l_connect)(void);
    int (*pdt$l_dconnect)(void);
    int (*pdt$l_add_scs_hdr)(void);
    int (*pdt$l_cancel_wait)(void);
    int (*pdt$l_map)(void);
    int (*pdt$l_unmap)(void);
    int (*pdt$l_fast_sendmsg_request)(void);
    int (*pdt$l_fast_sendmsg_ass_res_pm)(void);
    int (*pdt$l_fast_sendmsg_pm)(void);
    int (*pdt$l_alloc_rbun)(void);
    int (*pdt$l_dealloc_rbun)(void);
    int (*pdt$l_fast_recvmsg_chk_res)(void);
    int (*pdt$l_test_crash_port)(void);
    int (*pdt$l_test_ins_comqh)(void);
    int (*pdt$l_test_1_port)(void);
    int (*pdt$l_test_2_port)(void);
    int (*pdtdef$$_fill_4 [7])(void);
