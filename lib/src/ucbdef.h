...
#if 0
#define ucb$l_fqfl ucb$r_ucb.ucb$l_fqfl
#define ucb$w_unit_seed ucb$r_ucb.ucb$w_unit_seed
#define ucb$w_mb_seed ucb$r_ucb.ucb$w_mb_seed
#define ucb$l_rqfl ucb$r_ucb.ucb$l_rqfl
#define ucb$l_mb_msgqfl ucb$r_ucb.ucb$l_mb_msgqfl
#define ucb$l_fqbl ucb$r_ucb.ucb$l_fqbl
#define ucb$l_rqbl ucb$r_ucb.ucb$l_rqbl
#define ucb$l_mb_msgqbl ucb$r_ucb.ucb$l_mb_msgqbl
#define ucb$w_size ucb$r_ucb.ucb$w_size
#define ucb$b_type ucb$r_ucb.ucb$b_type
#define ucb$b_flck ucb$r_ucb.ucb$b_flck
#define ucb$l_fpc ucb$r_ucb.ucb$l_fpc
#define ucb$l_astqfl ucb$r_ucb.ucb$l_astqfl
#define ucb$l_mb_w_ast ucb$r_ucb.ucb$l_mb_w_ast
#define ucb$t_partner ucb$r_ucb.ucb$t_partner
#define ucb$l_fr3 ucb$r_ucb.ucb$l_fr3
#define ucb$l_astqbl ucb$r_ucb.ucb$l_astqbl
#define ucb$l_mb_r_ast ucb$r_ucb.ucb$l_mb_r_ast
#define ucb$l_fr4 ucb$r_ucb.ucb$l_fr4
#define ucb$w_msgmax ucb$r_ucb.ucb$w_msgmax
#define ucb$w_msgcnt ucb$r_ucb.ucb$w_msgcnt
#define ucb$l_first ucb$r_ucb.ucb$l_first
#define ucb$w_bufquo ucb$r_ucb.ucb$w_bufquo
#define ucb$w_dstaddr ucb$r_ucb.ucb$w_dstaddr
#define ucb$w_iniquo ucb$r_ucb.ucb$w_iniquo
#define ucb$w_srcaddr ucb$r_ucb.ucb$w_srcaddr
#define ucb$l_orb ucb$r_ucb.ucb$l_orb
#define ucb$l_lockid ucb$r_ucb.ucb$l_lockid
#define ucb$l_cpid ucb$r_ucb.ucb$l_cpid
#define ucb$ps_cram ucb$r_ucb.ucb$ps_cram
#define ucb$l_crb ucb$r_ucb.ucb$l_crb
#define ucb$l_dlck ucb$r_ucb.ucb$l_dlck
#define ucb$l_ddb ucb$r_ucb.ucb$l_ddb
#define ucb$l_pid ucb$r_ucb.ucb$l_pid
#define ucb$l_link ucb$r_ucb.ucb$l_link
#define ucb$l_vcb ucb$r_ucb.ucb$l_vcb
#define ucb$q_devchar ucb$r_ucb.ucb$q_devchar
#define ucb$l_devchar ucb$r_ucb.ucb$l_devchar
#define ucb$l_devchar2 ucb$r_ucb.ucb$l_devchar2
#define ucb$l_affinity ucb$r_ucb.ucb$l_affinity
#define ucb$l_xtra ucb$r_ucb.ucb$l_xtra
#define ucb$l_altiowq ucb$r_ucb.ucb$l_altiowq
#define ucb$b_devclass ucb$r_ucb.ucb$b_devclass
#define ucb$b_devtype ucb$r_ucb.ucb$b_devtype
#define ucb$w_devbufsiz ucb$r_ucb.ucb$w_devbufsiz
#define ucb$q_devdepend ucb$r_ucb.ucb$q_devdepend
#define ucb$l_devdepend ucb$r_ucb.ucb$l_devdepend
#define ucb$b_sectors ucb$r_ucb.ucb$b_sectors
#define ucb$b_tracks ucb$r_ucb.ucb$b_tracks
#define ucb$w_cylinders ucb$r_ucb.ucb$w_cylinders
#define ucb$b_vertsz ucb$r_ucb.ucb$b_vertsz
#define ucb$b_locsrv ucb$r_ucb.ucb$b_locsrv
#define ucb$b_remsrv ucb$r_ucb.ucb$b_remsrv
#define ucb$w_bytestogo ucb$r_ucb.ucb$w_bytestogo
#define ucb$l_devdepnd2 ucb$r_ucb.ucb$l_devdepnd2
#define ucb$l_tt_devdp1 ucb$r_ucb.ucb$l_tt_devdp1
#define ucb$w_tu_formenu ucb$r_ucb.ucb$w_tu_formenu
#define ucb$q_devdepend2 ucb$r_ucb.ucb$q_devdepend2
#define ucb$l_devdepnd3 ucb$r_ucb.ucb$l_devdepnd3
#define ucb$l_devdepnd4 ucb$r_ucb.ucb$l_devdepnd4
#define ucb$w_tmv_bcnt1 ucb$r_ucb.ucb$w_tmv_bcnt1
#define ucb$w_tmv_bcnt2 ucb$r_ucb.ucb$w_tmv_bcnt2
#define ucb$w_tmv_bcnt3 ucb$r_ucb.ucb$w_tmv_bcnt3
#define ucb$w_tmv_bcnt4 ucb$r_ucb.ucb$w_tmv_bcnt4
#define ucb$l_ioqfl ucb$r_ucb.ucb$l_ioqfl
#define ucb$l_ioqbl ucb$r_ucb.ucb$l_ioqbl
#define ucb$w_unit ucb$r_ucb.ucb$w_unit
#define ucb$w_charge ucb$r_ucb.ucb$w_charge
#define ucb$w_rwaitcnt ucb$r_ucb.ucb$w_rwaitcnt
#define ucb$b_cm1 ucb$r_ucb.ucb$b_cm1
#define ucb$b_cm2 ucb$r_ucb.ucb$b_cm2
#define ucb$l_irp ucb$r_ucb.ucb$l_irp
#define ucb$l_refc ucb$r_ucb.ucb$l_refc
#define ucb$b_dipl ucb$r_ucb.ucb$b_dipl
#define ucb$b_state ucb$r_ucb.ucb$b_state
#define ucb$b_amod ucb$r_ucb.ucb$b_amod
#define ucb$w_fill_0 ucb$r_ucb.ucb$w_fill_0
#define ucb$l_amb ucb$r_ucb.ucb$l_amb
#define ucb$l_sts ucb$r_ucb.ucb$l_sts
#define ucb$v_tim ucb$r_ucb.ucb$v_tim
#define ucb$v_int ucb$r_ucb.ucb$v_int
#define ucb$v_erlogip ucb$r_ucb.ucb$v_erlogip
#define ucb$v_cancel ucb$r_ucb.ucb$v_cancel
#define ucb$v_online ucb$r_ucb.ucb$v_online
#define ucb$v_power ucb$r_ucb.ucb$v_power
#define ucb$v_timout ucb$r_ucb.ucb$v_timout
#define ucb$v_inttype ucb$r_ucb.ucb$v_inttype
#define ucb$v_bsy ucb$r_ucb.ucb$v_bsy
#define ucb$v_mounting ucb$r_ucb.ucb$v_mounting
#define ucb$v_deadmo ucb$r_ucb.ucb$v_deadmo
#define ucb$v_valid ucb$r_ucb.ucb$v_valid
#define ucb$v_unload ucb$r_ucb.ucb$v_unload
#define ucb$v_template ucb$r_ucb.ucb$v_template
#define ucb$v_mntverip ucb$r_ucb.ucb$v_mntverip
#define ucb$v_wrongvol ucb$r_ucb.ucb$v_wrongvol
#define ucb$v_deleteucb ucb$r_ucb.ucb$v_deleteucb
#define ucb$v_lcl_valid ucb$r_ucb.ucb$v_lcl_valid
#define ucb$v_supmvmsg ucb$r_ucb.ucb$v_supmvmsg
#define ucb$v_mntverpnd ucb$r_ucb.ucb$v_mntverpnd
#define ucb$v_dismount ucb$r_ucb.ucb$v_dismount
#define ucb$v_clutran ucb$r_ucb.ucb$v_clutran
#define ucb$v_wrtlockmv ucb$r_ucb.ucb$v_wrtlockmv
#define ucb$v_svpn_end ucb$r_ucb.ucb$v_svpn_end
#define ucb$v_altbsy ucb$r_ucb.ucb$v_altbsy
#define ucb$v_snapshot ucb$r_ucb.ucb$v_snapshot
#define ucb$v_no_assign ucb$r_ucb.ucb$v_no_assign
#define ucb$v_exfunc_supp ucb$r_ucb.ucb$v_exfunc_supp
#define ucb$v_fast_path ucb$r_ucb.ucb$v_fast_path
#define ucb$v_pathverip ucb$r_ucb.ucb$v_pathverip
#define ucb$v_fp_hw_int ucb$r_ucb.ucb$v_fp_hw_int
#define ucb$v_fill_0_ ucb$r_ucb.ucb$v_fill_0_
#define ucb$l_devsts ucb$r_ucb.ucb$l_devsts
#define ucb$v_job ucb$r_ucb.ucb$v_job
#define ucb$v_devsts_gen_fill ucb$r_ucb.ucb$v_devsts_gen_fill
#define ucb$v_templ_bsy ucb$r_ucb.ucb$v_templ_bsy
#define ucb$v_fill_1_ ucb$r_ucb.ucb$v_fill_1_
#define ucb$v_prmmbx ucb$r_ucb.ucb$v_prmmbx
#define ucb$v_delmbx ucb$r_ucb.ucb$v_delmbx
#define ucb$v_fill_2_ ucb$r_ucb.ucb$v_fill_2_
#define ucb$v_devsts_tt_fill ucb$r_ucb.ucb$v_devsts_tt_fill
#define ucb$v_tt_timo ucb$r_ucb.ucb$v_tt_timo
#define ucb$v_tt_notif ucb$r_ucb.ucb$v_tt_notif
#define ucb$v_tt_hangup ucb$r_ucb.ucb$v_tt_hangup
#define ucb$v_tt_devsts_fill1 ucb$r_ucb.ucb$v_tt_devsts_fill1
#define ucb$v_tt_nologins ucb$r_ucb.ucb$v_tt_nologins
#define ucb$v_devsts_net_fill1 ucb$r_ucb.ucb$v_devsts_net_fill1
#define ucb$v_nt_bfrovf ucb$r_ucb.ucb$v_nt_bfrovf
#define ucb$v_devsts_net_fill2 ucb$r_ucb.ucb$v_devsts_net_fill2
#define ucb$v_nt_name ucb$r_ucb.ucb$v_nt_name
#define ucb$v_nt_break ucb$r_ucb.ucb$v_nt_break
#define ucb$v_fill_3_ ucb$r_ucb.ucb$v_fill_3_
#define ucb$v_ecc ucb$r_ucb.ucb$v_ecc
#define ucb$v_diagbuf ucb$r_ucb.ucb$v_diagbuf
#define ucb$v_nocnvrt ucb$r_ucb.ucb$v_nocnvrt
#define ucb$v_dx_write ucb$r_ucb.ucb$v_dx_write
#define ucb$v_datacache ucb$r_ucb.ucb$v_datacache
#define ucb$v_fill_4_ ucb$r_ucb.ucb$v_fill_4_
#define ucb$v_byte_fill_1 ucb$r_ucb.ucb$v_byte_fill_1
#define ucb$v_mscp_mntverip ucb$r_ucb.ucb$v_mscp_mntverip
#define ucb$v_mscp_initing ucb$r_ucb.ucb$v_mscp_initing
#define ucb$v_mscp_waitbmp ucb$r_ucb.ucb$v_mscp_waitbmp
#define ucb$v_mscp_flovr ucb$r_ucb.ucb$v_mscp_flovr
#define ucb$v_mscp_pkack ucb$r_ucb.ucb$v_mscp_pkack
#define ucb$v_mscp_wrtp ucb$r_ucb.ucb$v_mscp_wrtp
#define ucb$v_mscp_ignsrv ucb$r_ucb.ucb$v_mscp_ignsrv
#define ucb$v_mscp_mvrestart ucb$r_ucb.ucb$v_mscp_mvrestart
#define ucb$v_unused_fill ucb$r_ucb.ucb$v_unused_fill
#define ucb$v_du_shmv_strtd ucb$r_ucb.ucb$v_du_shmv_strtd
#define ucb$v_skip_datacache ucb$r_ucb.ucb$v_skip_datacache
#define ucb$v_du_0mnote ucb$r_ucb.ucb$v_du_0mnote
#define ucb$v_mvfkbbsy ucb$r_ucb.ucb$v_mvfkbbsy
#define ucb$v_gtunmbsy ucb$r_ucb.ucb$v_gtunmbsy
#define ucb$v_tu_ovrsqchk ucb$r_ucb.ucb$v_tu_ovrsqchk
#define ucb$v_tu_traceact ucb$r_ucb.ucb$v_tu_traceact
#define ucb$v_tu_seqnop ucb$r_ucb.ucb$v_tu_seqnop
#define ucb$v_tu_1dens ucb$r_ucb.ucb$v_tu_1dens
#define ucb$v_tu_dens_determined ucb$r_ucb.ucb$v_tu_dens_determined
#define ucb$v_tu_media_loaded ucb$r_ucb.ucb$v_tu_media_loaded
#define ucb$v_unused_fill_2 ucb$r_ucb.ucb$v_unused_fill_2
#define ucb$v_byte_fill_7 ucb$r_ucb.ucb$v_byte_fill_7
#define ucb$v_shd_wlg_inv ucb$r_ucb.ucb$v_shd_wlg_inv
#define ucb$v_byte_fill_2 ucb$r_ucb.ucb$v_byte_fill_2
#define ucb$v_shd_seqcmd_here ucb$r_ucb.ucb$v_shd_seqcmd_here
#define ucb$v_shd_seqcmd_there ucb$r_ucb.ucb$v_shd_seqcmd_there
#define ucb$v_shd_passive_mv ucb$r_ucb.ucb$v_shd_passive_mv
#define ucb$v_shd_node_failure ucb$r_ucb.ucb$v_shd_node_failure
#define ucb$v_shd_wlgsta_cha ucb$r_ucb.ucb$v_shd_wlgsta_cha
#define ucb$v_shd_vcb_dequeue ucb$r_ucb.ucb$v_shd_vcb_dequeue
#define ucb$v_port_online ucb$r_ucb.ucb$v_port_online
#define ucb$v_fklock ucb$r_ucb.ucb$v_fklock
#define ucb$v_msgfklock ucb$r_ucb.ucb$v_msgfklock
#define ucb$v_inifklock ucb$r_ucb.ucb$v_inifklock
#define ucb$v_bad_rev ucb$r_ucb.ucb$v_bad_rev
#define ucb$v_pa_erlogip ucb$r_ucb.ucb$v_pa_erlogip
#define ucb$v_mfqefklock ucb$r_ucb.ucb$v_mfqefklock
#define ucb$v_mfqe_lost ucb$r_ucb.ucb$v_mfqe_lost
#define ucb$v_byte_fill_6 ucb$r_ucb.ucb$v_byte_fill_6
#define ucb$v_admin_online ucb$r_ucb.ucb$v_admin_online
#define ucb$v_admin_init ucb$r_ucb.ucb$v_admin_init
#define ucb$v_admin_tear_down ucb$r_ucb.ucb$v_admin_tear_down
#define ucb$v_byte_fill_8 ucb$r_ucb.ucb$v_byte_fill_8
#define ucb$v_chan_online ucb$r_ucb.ucb$v_chan_online
#define ucb$v_chan_init ucb$r_ucb.ucb$v_chan_init
#define ucb$v_chan_tear_down ucb$r_ucb.ucb$v_chan_tear_down
#define ucb$v_byte_fill_9 ucb$r_ucb.ucb$v_byte_fill_9
#define ucb$v_pb_tqe_busy ucb$r_ucb.ucb$v_pb_tqe_busy
#define ucb$v_mbr_callback ucb$r_ucb.ucb$v_mbr_callback
#define ucb$v_shutdown_req ucb$r_ucb.ucb$v_shutdown_req
#define ucb$v_shutdown_ip ucb$r_ucb.ucb$v_shutdown_ip
#define ucb$v_pb_last_gasp_emulated ucb$r_ucb.ucb$v_pb_last_gasp_emulated
#define ucb$v_fill_5_ ucb$r_ucb.ucb$v_fill_5_
#define ucb$ps_start_aff_qfl ucb$r_ucb.ucb$ps_start_aff_qfl
#define ucb$ps_start_aff_qbl ucb$r_ucb.ucb$ps_start_aff_qbl
#define ucb$l_port_cpudb ucb$r_ucb.ucb$l_port_cpudb
#define ucb$ps_io_counters ucb$r_ucb.ucb$ps_io_counters
#define ucb$l_duetim ucb$r_ucb.ucb$l_duetim
#define ucb$l_opcnt ucb$r_ucb.ucb$l_opcnt
#define ucb$l_svpn ucb$r_ucb.ucb$l_svpn
#define ucb$l_svapte ucb$r_ucb.ucb$l_svapte
#define ucb$l_bcnt ucb$r_ucb.ucb$l_bcnt
#define ucb$l_boff ucb$r_ucb.ucb$l_boff
#define ucb$l_softerrcnt ucb$r_ucb.ucb$l_softerrcnt
#define ucb$l_ertcnt ucb$r_ucb.ucb$l_ertcnt
#define ucb$l_ertmax ucb$r_ucb.ucb$l_ertmax
#define ucb$l_errcnt ucb$r_ucb.ucb$l_errcnt
#define ucb$l_pdt ucb$r_ucb.ucb$l_pdt
#define ucb$l_ddt ucb$r_ucb.ucb$l_ddt
#define ucb$ps_adp ucb$r_ucb.ucb$ps_adp
#define ucb$ps_crctx ucb$r_ucb.ucb$ps_crctx
#define ucb$l_media_id ucb$r_ucb.ucb$l_media_id
#define ucb$v_media_id_nn ucb$r_ucb.ucb$v_media_id_nn
#define ucb$v_media_id_n2 ucb$r_ucb.ucb$v_media_id_n2
#define ucb$v_media_id_n1 ucb$r_ucb.ucb$v_media_id_n1
#define ucb$v_media_id_n0 ucb$r_ucb.ucb$v_media_id_n0
#define ucb$v_media_id_t1 ucb$r_ucb.ucb$v_media_id_t1
#define ucb$v_media_id_t0 ucb$r_ucb.ucb$v_media_id_t0
#define ucb$ps_dtn ucb$r_ucb.ucb$ps_dtn
#define ucb$ps_dtn_link ucb$r_ucb.ucb$ps_dtn_link
#define ucb$ps_toutrout ucb$r_ucb.ucb$ps_toutrout
#define ucb$ps_sud ucb$r_ucb.ucb$ps_sud
#endif
