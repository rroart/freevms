...
int   ioc_std$create_diobm (const struct _pte *va_pte, const UINT32 pte_count,
                            const UINT32 flags,
                            struct _pte **svapte_p, struct _diobm **diobm_p);
...
int   ioc_std$fill_diobm (struct _diobm *const diobm, const struct _pte *va_pte,
...
INT32       ioc$load_map (struct _adp *adp, struct _crctx *crctx, struct _pte *svapte, int boff,
                        void **dma_addr_p);
INT32   ioc_std$lock_dev (int lockmode, void *lock_val_p, struct _pcb *pcb, struct _ucb *ucb,
                        INT32 *lockid_p);
