...
int smg$create_pasteboard(long * pasteboard_id, void * output_device, signed int * number_of_pasteboard_rows,
        signed int * number_of_pasteboard_columns, unsigned int * flags, unsigned int * type_of_terminal, void * device_name)
{
    int status;
    *pasteboard_id = 0;
#if 0
...
int smg$erase_pasteboard(long * pasteboard_id, void * output_device, signed int * number_of_pasteboard_rows,
        signed int * number_of_pasteboard_columns, unsigned int * flags, unsigned int * type_of_terminal, void * device_name)
{
    // replace later
    char buf[16];
...
int smg$paste_virtual_display(long * display_id, long * pasteboard_id, int * pasteboard_row, int * pasteboard_column,
        long * top_display_id)
{
...
int smg$change_pbd_characteristics(long * pasteboard_id, int * desired_width, int * width, int * desired_height, int * height,
