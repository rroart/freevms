...
int smg$create_virtual_display(int * number_of_rows, int * number_of_columns, long * display_id, int * display_attributes,
...
#undef smg$put_chars
int smg$put_chars(long * display_id, void * text, int * start_row, int * start_column, int * flags, int * rendition_set,
...
// check connection to paste
#undef smg$put_line
int smg$put_line(long * display_id, void * text, int * line_advance, int * rendition_set, int * rendition_complement, int * flags,
        int * direction)
{
    struct dsc$descriptor * dsc = text;
    struct virtual_display * smg = *display_id;
...
int smg$change_virtual_display(long * display_id, int * number_of_rows, int * number_of_columns, int * display_attributes,
        int * video_attributes, int * character_set)
{
    int status;
    struct virtual_display * smg = *display_id;
...
int smg$insert_chars(long * display_id, void * character_string, int * start_row, int * start_column, int * rendition_set,
        int * rendition_complement, int * character_set)
{
...
int smg$insert_line(long * display_id, int * start_row, void * character_string, int * direction, int * rendition_set,
        int * rendition_complement, int * flags, int * character_set)
{
    struct dsc$descriptor * dsc = character_string;
    struct virtual_display * smg = *display_id;
    // replace later
...
int smg$label_border(long * display_id, void * text, int * position_code, int * units, int * rendition_set,
        int * rendition_complement, int * character_set)
{
    return SS$_NORMAL;
}
...
int smg$put_help_text(long * display_id, long * keyboard_id, void * help_topic, int * help_library, int * rendition_set,
        int * rendition_complement)
{
    return SS$_NORMAL;
}
