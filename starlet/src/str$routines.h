...
int str$compare_multi(const struct dsc$descriptor_s* first_source_string, const struct dsc$descriptor_s* second_source_string,
        const unsigned int* flags_value, const unsigned int* foreign_language);
...
int str$divide(const unsigned int* asign, const int* aexp, const struct dsc$descriptor_s* a_digits, const unsigned int* bsign,
        const int* bexp, const struct dsc$descriptor_s* b_digits, const int* total_digits,
        const unsigned int* round_truncate_indicator, unsigned int* csign, int* cexp, struct dsc$descriptor_s* cdigits);

int str$dupl_char(struct dsc$descriptor_s* destination_string, const int* repetition_count, const char* ascii_character);

int str$element(struct dsc$descriptor_s* destination_string, const int* element_number,
...
int str$find_first_substring(const struct dsc$descriptor_s* source_string, int* index, int* substring_index,
...
int str$left(struct dsc$descriptor_s* destination_string, const struct dsc$descriptor_s* source_string, const int* end_position);
...
int str$replace(struct dsc$descriptor_s* destination_string, const struct dsc$descriptor_s* source_string,
        const int* start_position, const int* end_position, const struct dsc$descriptor_s* replacement_string);
...
int str$round(const int* places, const unsigned int* flags, const unsigned int* asign, const int* aexp,
