...
int sys$setpri(unsigned int * pidadr, void * prcnam, unsigned int pri, unsigned int * prvpri, unsigned int * pol,
        unsigned int * prvpol)
{
...
int sys$create_region_32(unsigned long length, unsigned int region_prot, unsigned int flags, unsigned long long *return_region_id,
...
int sys$cpu_capabilities(int cpu_id, struct _generic_64 *select_mask, struct _generic_64 *modify_mask,
        struct _generic_64 *prev_mask, struct _generic_64 *flags)
{
