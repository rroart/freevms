...
int sys$crelnt(unsigned int *attr, void *resnam, unsigned int *reslen,
		unsigned int *quota, unsigned short *promsk, void *tabnam, void *partab,
...
int sys$dclast(void (*astadr)(unsigned long), unsigned long astprm,
		unsigned int acmode)
{
...
int sys$setimr(unsigned int efn, signed long long *daytim, void (*astadr)(long),
		unsigned long reqidt, unsigned int flags)
{
...
int sys$schdwk(unsigned int *pidadr, void *prcnam, signed long long * daytim,
...
int sys$deq(unsigned int lkid, void *valblk, unsigned int acmode,
		unsigned int flags)
{
...
int sys$getlki(unsigned int efn, unsigned int *lkidadr, void *itmlst,
		struct _iosb *iosb, void (*astadr)(int), int astprm,
...
int sys$deltva(struct _va_range *inadr, struct _va_range *retadr,
		unsigned int acmode)
{
...
int sys$create_region_32(unsigned long length, unsigned int region_prot,
		unsigned int flags, unsigned long long *return_region_id,
		void **return_va, unsigned long *return_length, unsigned long start_va)
{
...
int sys$getdvi(unsigned int efn, unsigned short int chan, void *devnam,
		void *itmlst, struct _iosb *iosb, void (*astadr)(), int astprm,
...
int sys$device_scan(void *return_devnam, unsigned short int *retlen,
		void *search_devnam, void *itmlst, unsigned long long *contxt)
{
	return INLINE_SYSCALL($device_scan,5,return_devnam,retlen,search_devnam,itmlst,contxt);
}

int sys$imgact(void * name, void * dflnam, void * hdrbuf, unsigned long imgctl,
		unsigned long long * inadr, unsigned long long * retadr,
		unsigned long long * ident, unsigned long acmode)
{
	struct struct_args s;
...
int sys$imgsta(void * transfer, void * parseinfo, void * header, void * file,
		unsigned long linkstatus, unsigned long clistatus)
{
	struct struct_args s;
...
int sys$creprc(unsigned int *pidadr, void *image, void *input, void *output,
...
int sys$getsyi(unsigned int efn, unsigned int *csidadr, void *nodename,
		void *itmlst, struct _iosb *iosb, void (*astadr)(),
...
int sys$getsyiw(unsigned int efn, unsigned int *csidadr, void *nodename,
		void *itmlst, struct _iosb *iosb, void (*astadr)(),
		unsigned long astprm)
{
	struct struct_args s;
...
int sys$set_security(void *clsnam, void *objnam, unsigned int *objhan,
		unsigned int flags, void *itmlst, unsigned int *contxt,
		unsigned int *acmode)
{
	struct struct_args s;
...
int sys$setddir(void * newdiraddr, unsigned short int * lengthaddr,
		void * curdiraddr)
{
...
{	NULL,NULL,NULL,NULL,0,0,0,
	{	0,0,0}};
struct _xabkeydef cc$rms_xabkey =
