...
int sys$setpri(unsigned int *pidadr, /* const */void *prcnam, unsigned int pri,
...
int sys$enqw(unsigned int efn, unsigned int lkmode, struct _lksb *lksb,
             ...
             void (*astadr)(void), unsigned long astprm, void (*blkastadr)(void),
...
int sys$crelnt(unsigned int *attr, void *resnam, unsigned
               int *reslen, unsigned int *quota, unsigned short *promsk, void *tabnam,
...
int sys$getdvi(unsigned int efn, unsigned short int chan, void *devnam,
               void *itmlst, struct _iosb *iosb, void (*astadr)(void), int astprm,
...
int sys$getsyi(unsigned int efn, unsigned int *csidadr, void *nodename,
               void *itmlst, struct _iosb *iosb, void (*astadr)(void),
...
struct struct_args
{
    unsigned long s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12, s13, s14,
             s15, s16;
};
