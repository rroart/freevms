...
unsigned long lib$analyze_sdesc(const struct dsc$descriptor_s *, unsigned short *, char **);

unsigned long lib$analyze_sdesc_64(const struct dsc$descriptor_s* descrip, unsigned short *word_integer_length, char **data_address,
...
unsigned long lib$build_nodespec(const struct dsc$descriptor_s *primary, struct dsc$descriptor_s *nodespec,
...
// not now?
#else
unsigned long lib$convert_date_string(const struct dsc$descriptor_s *, long long *, unsigned long *, unsigned long *,
...
unsigned long lib$cvt_dtb(int, const char *, long *), lib$cvt_htb(int, const char *, long *), lib$cvt_otb(int, const char *,
        long *);
...
unsigned long lib$ediv(const signed long int *divisor, const signed long long *dividend, signed long int *quotient,
        signed long int *remainder);

unsigned long lib$emodd(const double *, const unsigned char *, const double *, long *, double *), lib$emodf(const float *,
...
unsigned long lib$ffc(const int *, const int *, const void *, int *), lib$ffs(const int *, const int *, const void *, int *);

unsigned long lib$fid_to_name(const void *, const void *, void *, ...);

struct FAB;
unsigned long lib$file_scan(const struct FAB *, const unsigned long (*)(struct FAB *), const unsigned long (*)(struct FAB *),...);
...
unsigned long lib$getqui(const long *, const long *, const long *, const void *, const unsigned long *, long *, ...);
...
unsigned long lib$index(const struct dsc$descriptor_s *, const struct dsc$descriptor_s *);

unsigned long lib$init_date_time_context(unsigned long *, const long *, const void *);

int lib$init_timer(long * context);

long int lib$insert_tree(void *, void *, const unsigned long *, const int (*)(void *, void *, void *),
...
unsigned long lib$locc(const struct dsc$descriptor_s *char_string, const struct dsc$descriptor_s *source_string);
...
unsigned long lib$matchc(const struct dsc$descriptor_s *sub_string, const struct dsc$descriptor_s *search_string);
...
unsigned long lib$polyd(const double *, const short *, const double *, double *), lib$polyf(const float *, const short *,
        const float *, float *), lib$polyg(const double *, const short *, const double *, double *), lib$polyh(const void *,
        const short *, const void *, void *);
