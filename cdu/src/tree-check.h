...
#define STRUCTURE_STUFF_CHECK(t)    TREE_CHECK (t, STRUCTURE_STUFF)
#define STRUCTURE_DECL_CHECK(t) TREE_CHECK (t, STRUCTURE_DECL)
#define STRUCTURE_ATTR_CHECK(t) TREE_CHECK (t, STRUCTURE_ATTR)
#define STRUCTURE_TYPE_CHECK(t) TREE_CHECK (t, STRUCTURE_TYPE)
#define BIT_FIELD_REFS_CHECK(t) TREE_CHECK (t, BIT_FIELD_REFS)
