...
int  exe$modify  (struct _fab * fab, void * err, void * suc) { printk("not implemented\n"); }
int  exe$nxtvol  (struct _fab * fab, void * err, void * suc) { printk("not implemented\n"); }
int  exe$read  (struct _fab * fab, void * err, void * suc) { printk("not implemented\n"); }
int  exe$release  (struct _fab * fab, void * err, void * suc) { printk("not implemented\n"); }
int  exe$remove  (struct _fab * fab, void * err, void * suc) { printk("not implemented\n"); }
int  exe$rename  (struct _fab * fab, void * err, void * suc) { printk("not implemented\n"); }
int  exe$rewind  (struct _fab * fab, void * err, void * suc) { printk("not implemented\n"); }
