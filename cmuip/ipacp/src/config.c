...
static struct _fabdef    CFFAB_ = { fab$l_fna : "INET$CONFIG"
, fab$b_fns : 11, fab$b_rfm :
    FAB$C_VAR
}; // check was fnm
static struct _fabdef * CFFAB = & CFFAB_;
static struct _rabdef    CFRAB_ = { rab$l_fab :
    &CFFAB_,
rab$l_ubf :
    CFBUF,
rab$w_usz :
...
dsc$a_pointer :
        WKSimname
    }, *WKSimname_Desc=&WKSimname_Desc_;
...
dsc$a_pointer :
        WKSOutput
    }, *WKSOutput_Desc=&WKSOutput_Desc_;
...
dsc$a_pointer :
        RPCimname
    }, *RPCimname_Desc=&RPCimname_Desc_;
...
dsc$a_pointer :
        AUTHhostname
    }, *  AUTHhostname_Desc = & AUTHhostname_Desc_;
...
dsc$a_pointer :
        imagename
    }, *ImageName_Desc = &ImageName_Desc_;
    struct dsc$descriptor Quota_Desc_ =
    {
        dsc$w_length :0,
dsc$b_dtype :
