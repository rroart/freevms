...
lnmb$l_lnmx :
    &lnm_sys_dir_xlat,
lnmb$l_table :
    &lnm_sys_dir_table_header,
lnmb$b_flags :
    LNM$M_NO_ALIAS|LNM$M_TABLE|LNM$M_NO_DELETE,
    lnmb$b_count : 20,
...
{
lnmth$l_flags:
    LNMTH$M_SHAREABLE|LNMTH$M_DIRECTORY,
    lnmth$l_hash : 0,
    lnmth$l_orb  : 0,
lnmth$l_name :
    &lnm_sys_dir,
...
lnmb$l_lnmx :
    &lnm_sys_xlat,
lnmb$l_table :
    &lnm_sys_table_header,
lnmb$b_flags :
    LNM$M_NO_ALIAS|LNM$M_TABLE,
    lnmb$b_count : 16,
...
{
lnmth$l_flags:
    LNMTH$M_SYSTEM|LNMTH$M_SHAREABLE,
    lnmth$l_hash : 0,
    lnmth$l_orb  : 0,
lnmth$l_name :
    &lnm_sys,
