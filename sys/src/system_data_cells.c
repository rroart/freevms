...
struct _ihd * ctl$gl_imghdrbf;
struct _imcb * ctl$gl_imglstptr;
...
struct _lnmb * ctl$gl_lnmdirect; /* really p1 shell */
unsigned long ctl$gl_lnmdirseq;
struct lnmhshp * ctl$gl_lnmhash; /* really p1 shell */
