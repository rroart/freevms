...
struct lnmhshp * ctl$gl_lnmhash P1PP ;
struct _lnmb * ctl$gl_lnmdirect P1PP ;
...
struct _exh * ctl$gl_thexec P1PP = 0;
...
void * ctl$gl_ctlbasva P1PP ;
struct _ihd * ctl$gl_imghdrbf P1PP ;
struct _imcb * ctl$gl_imglstptr P1PP ;
struct _phd * ctl$gl_phd P1PP ;
...
struct _ccb * ctl$gl_ccbbase P1PP ;
...
struct _iaf * ctl$gl_fixuplnk P1PP ;
struct _iaf * ctl$gl_iaflnkptr P1PP ;
#endif
