...
#if 0
asmlinkage int exe_qiow_not(unsigned int efn, unsigned short int chan, unsigned int func, struct _iosb *iosb,
...
extern int sys$qio(unsigned int efn, unsigned short int chan, unsigned int func, struct _iosb *iosb,
        void (*astadr)(void *, unsigned long, void *), long astprm, void*p1, long p2, long p3, long p4, long p5, long p6);

asmlinkage int exe$qiow(unsigned int efn, unsigned short int chan, unsigned int func, struct _iosb *iosb,
        void (*astadr)(void *, unsigned long, void *), long astprm, void*p1, long p2, long p3, long p4, long p5, long p6)
{
...
asmlinkage int exe$qio(unsigned int efn, unsigned short chan, unsigned int func, struct _iosb *iosb,
        void (*astadr)(void *, unsigned long, void *), long astprm, void *p1, long p2, long p3, long p4, long p5, long p6)
{
    int retval = 0;
    unsigned int c, d;
    ...
    /** call i/o function */
    retval = ctl$ga_ccb_table[chan].ccb$l_ucb->ucb$l_ddt->ddt$l_fdt->fdt$ps_func_rtn[i->irp$v_fcode](i, p, i->irp$l_ucb,
            &ctl$gl_ccbbase[chan]); // a real beauty, isn't it :)
    setipl(oldipl); // temporary measure. should be 0 again?
    return retval;
    //  }
    earlyerror: setipl(oldipl);
